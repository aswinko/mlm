...
<body class="bg-slate-50">
    ...
    <div class="flex flex-col items-center justify-center mt-2 mb-4">
        <div class="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
                ...
                <form action="" method="POST">
                    <div class="flex flex-col mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input id="name" type="text" name="name" value="<?php echo htmlspecialchars($name); ?>" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-purple-400" placeholder="Name" required/>
                        </div>
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input id="phone_no" type="text" name="phone_no" value="<?php echo htmlspecialchars($phone_no); ?>" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-purple-400" placeholder="Mobile number" required/>
                        </div>
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <div class="relative">
                            ...
                            <span>
                                ...
                                <img class="w-6" src="./assets/icons/cloud-share.svg" alt="" style="filter: invert(72%) sepia(9%) saturate(361%) hue-rotate(179deg) brightness(90%) contrast(86%);">
                            </span>
                            </div>

                            <input id="sponser_id" value="<?php echo $get_sponser_id; ?>" type="text" name="sponser_id" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-purple-400" placeholder="Referral Code"/>
                        </div>
                    ...
                    <div class="flex w-full">
                        <button type="submit" name="register" class="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-purple-500 hover:bg-purple-600 rounded py-2 w-full transition duration-150 ease-in">
            ...
            <a href="./login.php" class="inline-flex items-center font-bold text-purple-500 hover:text-purple-600 text-xs text-center">
                <span>
                <svg class="h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
