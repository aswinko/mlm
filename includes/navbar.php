        ...
        <div class="px-6 w-full flex flex-wrap items-center justify-between">
            ...
            <div class="navbar-collapse collapse grow items-center" id="navbarSupportedContentY">
                <ul class="navbar-nav mr-auto lg:flex lg:flex-row lg:ml-10">
                    ...
                    <li class="nav-item pl-2">
                        <a class="nav-link block pr-2 lg:px-2 py-2 text-gray-600 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out" href="index.php#features" data-mdb-ripple="true" data-mdb-ripple-color="light">Features</a>
                    </li>
                    <li class="nav-item mb-2 lg:mb-0 pl-2">
                        <a class="nav-link block pr-2 lg:px-2 py-2 text-gray-600 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out" href="index.php#support" data-mdb-ripple="true" data-mdb-ripple-color="light">Support</a>
                    </li>
                </ul>
            </div>
